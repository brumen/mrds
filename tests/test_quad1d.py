...
# main testing class 
class quad1d_tests(unittest.TestCase):
    ...
    def test_gh_quad_gpu (self):
        print "Testing the gauss-hermite quadrature on GPU (1 dim)"
        ...
        print "cpu time1 =", t_cpu1
        print "cpu time2 =", t_cpu2
        print "gpu time  =", t_gpu

        self.assertTrue( ( diff1 < 0.5 ) & (diff2 < 0.5) )


    # testing gauss-hermite quadrature function search
    def test_gh_impl_quad_gpu (self):
        print "Testing the gauss-hermite quadrature search on GPU (1 dim)"
    ...
    def test_gh_quad_2d_gpu (self):
        print "Testing the gauss-hermite quadrature on GPU (2 dim)"
...
# running the tests 
suite = unittest.TestLoader().loadTestsFromTestCase(quad1d_tests)
