#
#   skew model for Spot processes, mostly used for tolling
#
...
class ComSkewSpot(ComSkew):
    """ Spot model used for commodity tolling, built on top of the skew spot model.
    """
...
class ComSkewSpotCuda(ComSkewSpot):
    """ Spot model used for commodity tolling, built on top of the skew spot model. For using CUDA.
    """
