...
void skew_fom_avx(double F, PyObject *delta_X, 
		  double c1_ch, double qv, double c2_ch, double c3_ch, 
		  PyObject *sim_fom, 
		  int nb_sim);
...
void test_1(PyObject *v1, PyObject *v2, PyObject *res, int len);

void do_start_shut(PyObject *dc_can, PyObject *dc_force,
		   PyObject *is_profitable, PyObject *do_action, 
		   int nb_sim);
