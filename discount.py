...
class DiscountCurve:
    ...
    @staticmethod
    def _discount_interp_fct2(
        time_diff: Union[float, datetime.date],
    ...
    def _interpolated_curve(self):
        ...
        return splrep(
            disc_tenors_numeric, np.exp(-disc_tenors_numeric * discount_yields)
    ...
    def discount_function(mkt_date: datetime.date, dcf=365.25):
        ...
        return lambda time_diff: DiscountCurve._discount_interp_fct2(
            time_diff, mkt_date, interpolated_curve
        )
    ...
    def discount_function_ql(mkt_date: datetime.date):
        ...
        eonia_curve_flat = ql.PiecewiseFlatForward(
            0, ql.TARGET(), eonia_helpers, ql.Actual365Fixed()
        )
