...
\input {packages.tex} %% packages included in the documentation
\input {preambule.tex} %% other commands
\input {pagesetting.tex} %% page sizes 


\title{{\bf MRD skew model for commodity prices}}
\author{Gorazd Brumen}
\date{First Version: July 28, 2010 
  \vskip 1mm
  This Version: \today
}
...
The {\it log-normal model} that the MRD proposes is given as follows. 
...
\end{eqnarray*}
The case for all tenors can be realized using tensor algebra INSERT HERE. 
