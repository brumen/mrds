...
# the parameters are:
# JW7   params: sigma_0, A,    B,     C,         P, alpha_C, alpha_P
# JWSS7 params: sigma_0, skew, smile, put_slope, put_bend, call_slope, call_bend
...
class JWSS7Volatility(ATMFVolatility):
    ...
    def _transform_params_jwss7(
        ...
        return (sigma_0, A, B, C, P, alpha_C, alpha_P)
...
class JWSS7VolatilityDisplay(JWSS7Volatility, VolatilityDrawMixin):
    ...
    def _plot_data(self, nb_points: int = 50):
        ...
        self._label_S0.config(text=f'S0={S0}')
        self.slider_sig_d.set(sigma_0)
        self.slider_skew_d.set(skew)
        self.slider_smile_d.set(smile)
        self.slider_put_slope_d.set(put_slope)
        self.slider_put_bend_d.set(put_bend)
        self.slider_call_slope_d.set(call_slope)
        self.slider_call_bend_d.set(call_bend)
        ...
        sigma_0 = float(self.slider_sig_d.get())
        skew = float(self.slider_skew_d.get())
        smile = float(self.slider_smile_d.get())
        put_slope = float(self.slider_put_slope_d.get())
        put_bend = float(self.slider_put_bend_d.get())
        call_slope = float(self.slider_call_slope_d.get())
    ...
    def _create_variables(self):
        ...
        self.slider_sig_d = tk.StringVar()
        self.slider_skew_d = tk.StringVar()
        self.slider_smile_d = tk.StringVar()
        self.slider_put_slope_d = tk.StringVar()
        self.slider_put_bend_d = tk.StringVar()
        self.slider_call_slope_d = tk.StringVar()
        self.slider_call_bend_d = tk.StringVar()
    ...
    def _create_sliders(self):
        ...
        self._sig_value = ttk.Entry(self.root, textvariable=self.slider_sig_d)
        self._sig_value.grid(row=1, column=3)
        ...
        self._skew_value = ttk.Entry(self.root, textvariable=self.slider_skew_d)
        self._skew_value.grid(row=2, column=3)
        ...
        self._smile_value = ttk.Entry(self.root, textvariable=self.slider_smile_d)
        self._smile_value.grid(row=3, column=3)
        ...
        self._put_slope_value = ttk.Entry(self.root, textvariable=self.slider_put_slope_d)
        self._put_slope_value.grid(row=4, column=3)
        ...
        self._put_bend_value = ttk.Entry(self.root, textvariable=self.slider_put_bend_d)
        self._put_bend_value.grid(row=5, column=3)
        ...
        self._call_slope_value = ttk.Entry(self.root, textvariable=self.slider_call_slope_d)
        self._call_slope_value.grid(row=6, column=3)
        ...
        self._call_bend_value = ttk.Entry(self.root, textvariable=self.slider_call_bend_d)
        self._call_bend_value.grid(row=7, column=3)
